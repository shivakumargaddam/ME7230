...
for iel = 1:numelem
    ...
    for igp = 1:size(w,2)
        ...
        % dnxy = [1 0 0 0; 0 0 0 1; 0 1 1 0]*[jac\[dns(1) 0 dns(2) 0 dns(3) 0 dns(4) 0; dnt(1) 0 dnt(2) 0 dnt(3) 0 dnt(4) 0]; jac\[0 dns(1) 0 dns(2) 0 dns(3) 0 dns(4); 0 dnt(1) 0 dnt(2) 0 dnt(3) 0 dnt(4)]] ;
        dnxy = inv(jac)*[dns;dnt];
        B = [dnxy(1,1) 0 dnxy(1,2) 0 dnxy(1,3) 0 dnxy(1,4) 0; 0 dnxy(2,1) 0 dnxy(2,2) 0 dnxy(2,3) 0 dnxy(2,4) ; dnxy(2,1) dnxy(1,1) dnxy(2,2) dnxy(1,2) dnxy(2,3) dnxy(1,3) dnxy(2,4) dnxy(1,4)];
        ...
        % linear form
        body = [0 0]';
        bforce = [n(1) 0 n(2) 0 n(3) 0 n(4) 0; 0 n(1) 0 n(2) 0 n(3) 0 n(4)]'*body*w(igp)*det(jac);
